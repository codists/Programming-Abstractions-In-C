...
int main(int argc, char const *argv[]) {
    ...
    AnnounceWinner(nCoins, whoseTrun);
    return 0;
}
 ...
 * -----------------------------------------
 * This function announce the final result of the game.
 */
static void AnnounceWinner(int nCoins, playerT whoseTurn) {
    if (nCoins == 0) {
 ...
 * Usage: nTaken = GerUserMove(nCoins);
 * ------------------------------------
 ...
 * -------------------------------------------
 * The function figures out what move is best for the computer
 ...
 * depends on the recursive insight tht a good move is one
 ...
 * -------------------------------------
 * This function return TRUE if nCoins is a bad position.
